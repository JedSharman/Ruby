 ...
 */
   ...
   /**
    * Select the ADC1 Alternative Trigger sources.
    * If PDB is selected then Pre-trigger 0/1 is determined by the PDB setup
    * otherwise Pre-trigger 0/1 is determined by this selection.
    */
   enum SimAdc1AltTrigger {
      SimAdc1AltTrigger_Pdb           = SIM_SOPT7_ADC1ALTTRGEN(0),                              //!< PDB trigger
      SimAdc1AltTrigger_PreTrigger_0  = SIM_SOPT7_ADC1ALTTRGEN(1)|SIM_SOPT7_ADC1PRETRGSEL(0),   //!< Pre-trigger 0 = A (SC1[0])
      SimAdc1AltTrigger_PreTrigger_1  = SIM_SOPT7_ADC1ALTTRGEN(1)|SIM_SOPT7_ADC1PRETRGSEL(1),   //!< Pre-trigger 1 = B (SC1[1])
   };
...
public:
    ...
    * If PDB is selected by SimAdc0Trigger then Pre-trigger 0/1 is determined by the PDB setup,
    * otherwise Pre-trigger 0/1 is determined by this parameter.
    * For example, setAdc1Triggers(SimAdc1AltTrigger_PreTrigger_1, SimAdc1Trigger_PitCh0) will set the trigger source
    * to PIT channel 0 and conversion will use SC1[1]/R[1]. 
    *
    * @param[in] simAdc1AltTrigger  Select the ADC1 Alternative Trigger sources 
    * @param[in] simAdc1Trigger     Select the ADC1 Trigger source in STOP and VLPS modes, or when ADC0 Alternative Trigger is active.
    */
   static void setAdc1Triggers(SimAdc1AltTrigger simAdc1AltTrigger, SimAdc1Trigger simAdc1Trigger=SimAdc1Trigger_PdbExTrig) {
      sim->SOPT7 = sim->SOPT7 = (sim->SOPT7&~(SIM_SOPT7_ADC1TRGSEL_MASK|SIM_SOPT7_ADC1ALTTRGEN_MASK))|simAdc1Trigger|simAdc1AltTrigger;
   };
...
public:
   ...
   //! Address of clock register for peripheral
   static constexpr volatile uint32_t *clockReg  = (volatile uint32_t *)(SIM_BasePtr+offsetof(SIM_Type,SCGC3));
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   3: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   4: ADC1_SE4b            = PTC8 (p53)                     */  { PortCInfo,  GPIOC_BasePtr,  8,       PORT_PCR_MUX(0)|defaultPcrValue  },
   ...
   static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
      ...
      PORTC->GPCLR = pcrValue|PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x0100UL);
   }
   ...
   static void clearPCRs() {
      ...
      PORTC->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x100U);
   }
...
public:
   //! Hardware base pointer
   static constexpr volatile CAN_Type *can   = (volatile CAN_Type *)CAN0_BasePtr;
   ...
   //! IRQ numbers for hardware
   static constexpr IRQn_Type irqNums[]  = {
      CAN0_Message_IRQn, CAN0_BusOff_IRQn, CAN0_Error_IRQn, CAN0_Tx_IRQn, 
      CAN0_Rx_IRQn, CAN0_WakeUp_IRQn, };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: CMP0_IN2             = PTC8 (p53)                     */  { PortCInfo,  GPIOC_BasePtr,  8,       PORT_PCR_MUX(0)|defaultPcrValue  },
...
public:
   //! Hardware base pointer
   static constexpr volatile CMP_Type *cmp   = (volatile CMP_Type *)CMP2_BasePtr;
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: CMP2_IN0             = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   1: CMP2_IN1             = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   2: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   3: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   4: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         ...
         /*   6: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   7: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   8: CMP2_OUT             = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   3: EZP_CLK              = PTA0 (p22)                     */  { PortAInfo,  GPIOA_BasePtr,  0,       PORT_PCR_MUX(7)|defaultPcrValue  },
         /*   4: JTAG_TDI             = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   5: EZP_DI               = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   6: JTAG_TDO             = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   7: TRACE_SWO            = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   8: EZP_DO               = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   9: JTAG_TMS             = PTA3 (p25)                     */  { PortAInfo,  GPIOA_BasePtr,  3,       PORT_PCR_MUX(7)|defaultPcrValue  },
         /*  10: SWD_DIO              = PTA3 (p25)                     */  { PortAInfo,  GPIOA_BasePtr,  3,       PORT_PCR_MUX(7)|defaultPcrValue  },
         /*  11: NMI_b                = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*  12: EZP_CS_b             = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*  13: JTAG_TRST_b          = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*  14: CLKOUT               = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*  15: TRACE_CLKOUT         = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*  16: TRACE_D3             = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
   };
...
public:
   ...
   //! Address of clock register for peripheral
   static constexpr volatile uint32_t *clockReg  = (volatile uint32_t *)(SIM_BasePtr+offsetof(SIM_Type,SCGC2));
...
public:
   ...
   // Template:dmamux0_16ch_trig_mk22fa12
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*  54: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  55: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  56: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  57: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  58: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  59: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  60: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  61: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  62: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         ...
         /*  70: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  71: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  72: FB_ALE               = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*  73: FB_OE_b              = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*  74: FB_RW_b              = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*  75: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  76: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
...
/**
 * Peripheral information for FTFE, Flash Memory Module.
 * 
 * This may include pin information, constants, register addresses, and default register values,
 * along with simple accessor functions.
 */
...
public:
   //! Hardware base pointer
   static constexpr volatile FTFE_Type *ftfe   = (volatile FTFE_Type *)FTFE_BasePtr;
   ...
   // Template:ftfe_128k_flexrom

   // Sector size for program flash (minimum erase element)
   static constexpr unsigned programFlashSectorSize = 4096;

   // Phrase size for program flash (minimum programming element)
   static constexpr unsigned programFlashPhraseSize = 8;

   // Sector size for data flash (minimum erase element)
   static constexpr unsigned dataFlashSectorSize = 4096;

   // Phrase size for data flash (minimum programming element)
   static constexpr unsigned dataFlashPhraseSize = 8;
   ...
   static constexpr PartitionInformation partitionInformation[] {
         // Flash   Backing   Value
         { 128*1024,   0*1024, 0xFF},
         {  96*1024,  32*1024, 0x03},
         {  64*1024,  64*1024, 0x04},
         {  32*1024,  96*1024, 0x0B},
         {   0*1024, 128*1024, 0x05},
   };
   ...
   enum PartitionSel {
      partition_flash128K_eeprom0K,
      partition_flash96K_eeprom32K,
      partition_flash64K_eeprom64K,
      partition_flash32K_eeprom96K,
      partition_flash0K_eeprom128K,
   
      // All EEPROM
      partition_flash0K_eeprom_all = partition_flash0K_eeprom128K,
   };
   ...
   //! FlexNVM - EEPROM size
   static constexpr EepromSel eepromSel = eeprom4KBytes;

   //! FlexNVM - Flash EEPROM partition
   static constexpr PartitionSel partitionSel = partition_flash0K_eeprom128K;
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: FTM0_CH2             = PTC5 (p50)                     */  { PortCInfo,  GPIOC_BasePtr,  5,       PORT_PCR_MUX(7)|defaultPcrValue  },
         ...
         /*   5: FTM0_CH5             = PTD5 (p62)                     */  { PortDInfo,  GPIOD_BasePtr,  5,       PORT_PCR_MUX(4)|defaultPcrValue  },
         /*   6: FTM0_CH6             = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   7: FTM0_CH7             = PTD7 (p64)                     */  { PortDInfo,  GPIOD_BasePtr,  7,       PORT_PCR_MUX(4)|defaultPcrValue  },
   };
   ...
   static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
      ...
      PORTC->GPCLR = pcrValue|PORT_PCR_MUX(4)|PORT_GPCLR_GPWE(0x0014UL);
      PORTC->GPCLR = pcrValue|PORT_PCR_MUX(7)|PORT_GPCLR_GPWE(0x0020UL);
      PORTD->GPCLR = pcrValue|PORT_PCR_MUX(4)|PORT_GPCLR_GPWE(0x00B0UL);
   }
   ...
   static void clearPCRs() {
      ...
      PORTC->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x34U);
      PORTD->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0xB0U);
   }
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
            /*   0: FTM0_FLT0            = PTD6 (p63)                     */  { PortDInfo,  GPIOD_BasePtr,  6,       PORT_PCR_MUX(6)|defaultPcrValue  },
            /*   1: FTM0_FLT1            = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
            /*   2: FTM0_FLT2            = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
            /*   3: FTM0_FLT3            = PTB2 (p37)                     */  { PortBInfo,  GPIOB_BasePtr,  2,       PORT_PCR_MUX(6)|defaultPcrValue  },
      };
      ...
      static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
         ...
         PORTB->GPCLR = pcrValue|PORT_PCR_MUX(6)|PORT_GPCLR_GPWE(0x0004UL);
         PORTD->GPCLR = pcrValue|PORT_PCR_MUX(6)|PORT_GPCLR_GPWE(0x0040UL);
      }
...
public:
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
            /*   0: FTM1_QD_PHA          = PTA12 (p28)                    */  { PortAInfo,  GPIOA_BasePtr,  12,      PORT_PCR_MUX(7)|defaultPcrValue  },
            /*   1: FTM1_QD_PHB          = PTA13 (p29)                    */  { PortAInfo,  GPIOA_BasePtr,  13,      PORT_PCR_MUX(7)|defaultPcrValue  },
      };
      ...
      static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
         ...
         PORTA->GPCLR = pcrValue|PORT_PCR_MUX(7)|PORT_GPCLR_GPWE(0x3000UL);
      }
      ...
      static void clearPCRs() {
         ...
         PORTA->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x3000U);
      }
...
public:
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
            /*   0: FTM2_QD_PHA          = PTB18 (p41)                    */  { PortBInfo,  GPIOB_BasePtr,  18,      PORT_PCR_MUX(6)|defaultPcrValue  },
            /*   1: FTM2_QD_PHB          = PTB19 (p42)                    */  { PortBInfo,  GPIOB_BasePtr,  19,      PORT_PCR_MUX(6)|defaultPcrValue  },
      };
      ...
      static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
         ...
         PORTB->GPCHR = pcrValue|PORT_PCR_MUX(6)|PORT_GPCHR_GPWE(0x000CUL);
      }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: FTM3_CH0             = PTD0 (p57)                     */  { PortDInfo,  GPIOD_BasePtr,  0,       PORT_PCR_MUX(4)|defaultPcrValue  },
         /*   1: FTM3_CH1             = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   2: FTM3_CH2             = PTD2 (p59)                     */  { PortDInfo,  GPIOD_BasePtr,  2,       PORT_PCR_MUX(4)|defaultPcrValue  },
   ...
   static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
      ...
      PORTD->GPCLR = pcrValue|PORT_PCR_MUX(4)|PORT_GPCLR_GPWE(0x0005UL);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: I2C0_SCL             = PTB0 (p35)                     */  { PortBInfo,  GPIOB_BasePtr,  0,       PORT_PCR_MUX(2)|defaultPcrValue  },
         /*   1: I2C0_SDA             = PTB1 (p36)                     */  { PortBInfo,  GPIOB_BasePtr,  1,       PORT_PCR_MUX(2)|defaultPcrValue  },
   };
...
public:
   //! Hardware base pointer
   static constexpr volatile I2C_Type *i2c   = (volatile I2C_Type *)I2C2_BasePtr;

   //! Clock mask for peripheral
   static constexpr uint32_t clockMask = SIM_SCGC1_I2C2_MASK;

   //! Address of clock register for peripheral
   static constexpr volatile uint32_t *clockReg  = (volatile uint32_t *)(SIM_BasePtr+offsetof(SIM_Type,SCGC1));
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: I2C2_SCL             = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   1: I2C2_SDA             = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   8: I2S0_RXD1            = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: LLWU_P0              = PTE1 (p2)                      */  { PortEInfo,  GPIOE_BasePtr,  1,       PORT_PCR_MUX(1)|defaultPcrValue  },
         /*   1: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   2: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
    ...
    */
   static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
      enablePortClocks(PORTC_CLOCK_MASK|PORTE_CLOCK_MASK);

      PORTC->GPCLR = pcrValue|PORT_PCR_MUX(1)|PORT_GPCLR_GPWE(0x0802UL);
      PORTE->GPCLR = pcrValue|PORT_PCR_MUX(1)|PORT_GPCLR_GPWE(0x0002UL);
   }
   ...
   static void clearPCRs() {
      ...
      PORTC->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x802U);
      PORTE->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x2U);
   }
...
public:
   //! Hardware base pointer
   static constexpr volatile MPU_Type *mpu   = (volatile MPU_Type *)MPU_BasePtr;
...
public:
   ...
   // Template:pdb0_2ch_2trig_2dac_3po
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   3: VDD3                 = VDD3 (p47)                     */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         ...
         /*  11: VSS3                 = VSS3 (p48)                     */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: SPI0_SCK             = PTD1 (p58)                     */  { PortDInfo,  GPIOD_BasePtr,  1,       PORT_PCR_MUX(2)|defaultPcrValue  },
         /*   1: SPI0_SIN             = PTC7 (p52)                     */  { PortCInfo,  GPIOC_BasePtr,  7,       PORT_PCR_MUX(2)|defaultPcrValue  },
         /*   2: SPI0_SOUT            = PTC6 (p51)                     */  { PortCInfo,  GPIOC_BasePtr,  6,       PORT_PCR_MUX(2)|defaultPcrValue  },
         /*   3: SPI0_PCS0            = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   4: SPI0_PCS1            = PTC3 (p46)                     */  { PortCInfo,  GPIOC_BasePtr,  3,       PORT_PCR_MUX(2)|defaultPcrValue  },
   ...
   static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
      ...
      PORTC->GPCLR = pcrValue|PORT_PCR_MUX(2)|PORT_GPCLR_GPWE(0x00C8UL);
      PORTD->GPCLR = pcrValue|PORT_PCR_MUX(2)|PORT_GPCLR_GPWE(0x0002UL);
   }
   ...
   static void clearPCRs() {
      ...
      PORTC->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0xC8U);
...
using Adc_p53              = const USBDM::Adc1Channel<4>;
 ...
 * @{
 */
using Ftm_p45              = const USBDM::Ftm0Channel<1>;
using Ftm_p49              = const USBDM::Ftm0Channel<3>;
using Ftm_p50              = const USBDM::Ftm0Channel<2>;
using Ftm_p61              = const USBDM::Ftm0Channel<4>;
using Ftm_p62              = const USBDM::Ftm0Channel<5>;
using Ftm_p64              = const USBDM::Ftm0Channel<7>;
using Ftm_p57              = const USBDM::Ftm3Channel<0>;
using Ftm_p59              = const USBDM::Ftm3Channel<2>;
/** 
 * End group FTM_Group
 * @}
 */
 ...
 *  ------------------------ | --------------------------------------------|---------------------------| ------------- 
 *  ADC0_DM0                 | ADC0_DM0/ADC1_DM3                           | p10                       | N/C       
 *  ADC0_DP0                 | ADC0_DP0/ADC1_DP3                           | p9                        | N/C       
 *  ADC1_DM0                 | ADC1_DM0/ADC0_DM3                           | p12                       | N/C       
 *  ADC1_DP0                 | ADC1_DP0/ADC0_DP3                           | p11                       | N/C       
 *  DAC0_OUT                 | DAC0_OUT/CMP1_IN3/ADC0_SE23                 | p18                       | DAC_OUT       
 *  EXTAL32                  | EXTAL32                                     | p20                       | N/C       
 *  PTA0                     | JTAG_TCLK/SWD_CLK/EZP_CLK                   | p22                       | SWD_CLK       
 *  PTA1                     | UART0_RX                                    | p23                       | UART_RX (Alt)       
 *  PTA2                     | UART0_TX                                    | p24                       | UART_TX (Alt)       
 *  PTA3                     | JTAG_TMS/SWD_DIO                            | p25                       | SWD_DIO       
 *  PTA4                     | -                                           | p26                       | -       
 *  PTA5                     | GPIOA_5                                     | p27                       | GPIOA_5 = QD1_Index       
 *  PTA12                    | FTM1_QD_PHA                                 | p28                       | QD1_PHA       
 *  PTA13                    | FTM1_QD_PHB                                 | p29                       | QD1_PHB       
 *  PTA18                    | EXTAL0                                      | p32                       | EXTAL0       
 *  PTA19                    | XTAL0                                       | p33                       | XTAL0       
 *  PTB0                     | I2C0_SCL                                    | p35                       | I2C_SCL       
 *  PTB1                     | I2C0_SDA                                    | p36                       | I2C_SDA       
 *  PTB2                     | FTM0_FLT3                                   | p37                       | Fault3 = ErrorFlag1       
 *  PTB3                     | GPIOB_3                                     | p38                       | GPIOB_3 = QD2_Index       
 *  PTB16                    | -                                           | p39                       | UART_RX       
 *  PTB17                    | -                                           | p40                       | UART_TX       
 *  PTB18                    | FTM2_QD_PHA                                 | p41                       | QD2_PHA       
 *  PTB19                    | FTM2_QD_PHB                                 | p42                       | QD2_PHB       
 *  PTC0                     | GPIOC_0                                     | p43                       | GPIOC_0 = Hall sensor2_A       
 *  PTC1                     | GPIOC_1/LLWU_P6                             | p44                       | GPIOC_1 = Hall sensor2_B       
 *  PTC2                     | FTM0_CH1                                    | p45                       | FTM0_CH1 = Grabber2       
 *  PTC3                     | SPI0_PCS1                                   | p46                       | SPI-PCS       
 *  PTC4                     | FTM0_CH3                                    | p49                       | FTM0_CH3 = Motor1_B       
 *  PTC5                     | FTM0_CH2                                    | p50                       | FTM0_CH2 = Motor1_A       
 *  PTC6                     | SPI0_SOUT                                   | p51                       | SPI-SOUT       
 *  PTC7                     | SPI0_SIN                                    | p52                       | SPI-SIN       
 *  PTC8                     | ADC1_SE4b/CMP0_IN2                          | p53                       | VmTap       
 *  PTC9                     | GPIOC_9                                     | p54                       | TP       
 *  PTC10                    | -                                           | p55                       | -       
 *  PTC11                    | GPIOC_11/LLWU_P11                           | p56                       | TP       
 *  PTD0                     | FTM3_CH0                                    | p57                       | QD1_PHA (IC)       
 *  PTD1                     | SPI0_SCK                                    | p58                       | SPI-SCK       
 *  PTD2                     | FTM3_CH2                                    | p59                       | QD2_PHA (IC)       
 *  PTD3                     | -                                           | p60                       | -       
 *  PTD4                     | FTM0_CH4                                    | p61                       | FTM0_CH4 = Motor2_B       
 *  PTD5                     | FTM0_CH5                                    | p62                       | FTM0_CH5 = Motor2_A       
 *  PTD6                     | FTM0_FLT0                                   | p63                       | Fault0 = ErrorFlag2       
 *  PTD7                     | FTM0_CH7                                    | p64                       | FTM0_CH7 = Grabber1       
 *  PTE0                     | GPIOE_0                                     | p1                        | GPIOE_0 = Hall sensor1_A       
 *  PTE1                     | GPIOE_1/LLWU_P0                             | p2                        | GPIOE_1 = Hall sensor1_B       
 *  RESET_b                  | RESET_b                                     | p34                       | Reset switch, SWD       
