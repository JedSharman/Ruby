...
void UART5_RxTx_IRQHandler(void)              WEAK_DEFAULT_HANDLER;
...
VectorTable const __vector_table = {
   ...
   &__StackTop,                                /*    0   -16  Initial stack pointer                                                            */
   {
      ...
      UART4_RxTx_IRQHandler,                   /*   82,   66  Serial Communication Interface                                                   */
      UART4_Error_IRQHandler,                  /*   83,   67  Serial Communication Interface                                                   */
      UART5_RxTx_IRQHandler,                   /*   84,   68  Serial Communication Interface                                                   */
      UART5_Error_IRQHandler,                  /*   85,   69  Serial Communication Interface                                                   */
